...
\begin{summary}
This paper explores how quantum algorithms might accelerate numerical PDE solvers through primitives like quantum linear-system solvers, Hamiltonian simulation, and structured matrix representations.
\end{summary}
